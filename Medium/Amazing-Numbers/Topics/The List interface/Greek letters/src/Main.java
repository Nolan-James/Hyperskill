...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Objects.toString(letterList.get(0)));
        System.out.println(Objects.toString(letterList.get(1)));
        System.out.println(Objects.toString(letterList.get(2)));
